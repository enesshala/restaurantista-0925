document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateTestimonials(testimonials, index) {
        ...
        cardElements.forEach((card) => {
            ...
            container.querySelector(".testimonial-name").textContent =
                data.name;
            container.querySelector(".testimonial-role").textContent =
                data.role;
            container.querySelector(".testimonial-text").textContent =
                data.text;
        });
    }
    ...
    leftArrow.addEventListener("click", () => {
        currentIndex =
            currentIndex > 0 ? currentIndex - 1 : testimonialsData.length - 1; // ternary operator
        // if (currentIndex > 0) {
    ...
    rightArrow.addEventListener("click", () => {
        currentIndex =
            currentIndex < testimonialsData.length - 1 ? currentIndex + 1 : 0; // ternary operator
